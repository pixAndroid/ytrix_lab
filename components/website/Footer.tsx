        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 mb-6 leading-relaxed">
              Building cutting-edge software solutions for the modern world. We turn complex ideas into elegant products.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Web Development', 'Mobile Apps', 'AI/ML Solutions', 'Cloud Infrastructure', 'UI/UX Design', 'DevOps'].map(
                (item) => (
                  <li key={item}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          ...
          <div className="flex gap-6">
            {[
              ...
              <Link key={label} href={href} className="text-sm text-gray-500 hover:text-gray-300 transition-colors">
                {label}
              </Link>
            ))}
          </div>
